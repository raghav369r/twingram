  ...
  return (
    <div className="flex w-full justify-around items-center bg-black overflow-x-scroll z-10">
      <NavLink
        to="/"
        className={
          "px-3 py-1.5 " + (pathname == "/" ? "border-t-4 border-blue-700" : "")
        }
      >
      ...
      <NavLink
        ...
        className={
          "px-3 py-1.5 " +
          (pathname == "/explore" ? "border-t-4 border-blue-700" : "")
        }
      >
      ...
      <NavLink
        ...
        className={
          "px-3 py-1.5 " +
          (pathname == "/people" ? "border-t-4 border-blue-700" : "")
        }
      >
      ...
      <NavLink
        ...
        className={
          "px-3 py-1.5 " +
          (pathname == "/saved" ? "border-t-4 border-blue-700" : "")
        }
      >
        <img
      ...
      <NavLink
        ...
        className={
          "px-3 py-1.5 " +
          (pathname == "/create-post" ? "border-t-4 border-blue-700" : "")
        }
      >
        <MdCreateNewFolder className="size-6" />
      </NavLink>
      <h1 to="/" className="px-3 py-1.5 cursor-pointer" onClick={handleLogout}>
